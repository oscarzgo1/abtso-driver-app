...
/** The "Calendar [React Day Picker]" catalogue component (originui,
 * "Appointment picker" demo) — copied verbatim. Its classNames lean on
 * this project's own Tailwind theme tokens (bg-primary, text-foreground,
 * text-muted-foreground, etc.), which already map to the real brand
 * palette (--color-primary is var(--brand-red) — see index.css's @theme
 * block), so the selected/range/today styling below renders in brand red
 * automatically without any component-level colour overrides. */
