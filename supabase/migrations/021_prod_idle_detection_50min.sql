-- ============================================================
-- ABTSO Logistics — Migration 021: Production Idle Detection (50 Minutes)
-- ============================================================
-- Updates detect_idle_drivers() RPC threshold from testing (2 mins)
-- to production requirement of 50 minutes.
-- ============================================================
...
BEGIN 
  ...
  LOOP 
    ...
    IF (v_speed IS NULL OR v_speed < 0.5) THEN 
        ...
        -- PRODUCTION SETTING: 50 MINUTES 
        IF COALESCE(v_started_at, v_last_ping) <= now() - INTERVAL '50 minutes' THEN 
